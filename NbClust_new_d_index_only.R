NbClust_new <- function (data = NULL, diss = NULL, distance = "euclidean", 
...
#               "\n", "\n"))
    inertia.gains <- res[, 29]
    inertia.change <- DiffLev[, 12]
    results.final <- list(inertia.gains, inertia.change)
    # ?return
  }
